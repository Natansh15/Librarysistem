        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header with-border">
              <a href="#addnew" data-toggle="modal" class="btn btn-primary btn-sm btn-flat"><i class="fa fa-plus"></i> Devoluciones</a>
            </div>
            <div class="box-body">
                  ...
                  <?php
                    ...
                    while($row = $query->fetch_assoc()){
                      if($row['status']){
                        ...
                        $status = '<span class="label label-success">devuelto</span>';
                      }
                      echo "
                        <tr>
                          <td class='hidden'></td>

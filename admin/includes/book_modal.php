    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	...
            	<h4 class="modal-title"><b>Añadir Nuevo Libro</b></h4>
          	</div>
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="publisher" class="col-sm-3 control-label">Editorial</label>
                ...
                <div class="form-group">
                    <label for="datepicker_add" class="col-sm-3 control-label">Fecha de Publicación</label>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
          	<div class="modal-header">
            	<button type="button" class="close" data-dismiss="modal" aria-label="Cerrar">
              		<span aria-hidden="true">&times;</span></button>
            	<h4 class="modal-title"><b>Editar Libro</b></h4>
          	</div>
          	<div class="modal-body">
                ...
                <div class="form-group">
                    <label for="edit_author" class="col-sm-3 control-label">Autor</label>
                ...
                <div class="form-group">
                    <label for="edit_publisher" class="col-sm-3 control-label">Editorial</label>
                ...
                <div class="form-group">
                    <label for="datepicker_edit" class="col-sm-3 control-label">Fecha de Publicación</label>
